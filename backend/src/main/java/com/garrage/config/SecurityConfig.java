    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        // Garage Admin (and super admin) endpoints
                        .requestMatchers("/api/admin/bookings/**").hasAnyRole("GARAGE_ADMIN", "SUPER_ADMIN")
                        .requestMatchers("/api/customers/**").hasAnyRole("GARAGE_ADMIN", "SUPER_ADMIN")
                        .requestMatchers("/api/vehicles/**").hasAnyRole("GARAGE_ADMIN", "SUPER_ADMIN")
                        .requestMatchers("/api/orders/**").hasAnyRole("GARAGE_ADMIN", "SUPER_ADMIN")
                        .requestMatchers("/api/parts/**").hasAnyRole("GARAGE_ADMIN", "SUPER_ADMIN")
                        .requestMatchers("/api/vendors").hasAnyRole("GARAGE_ADMIN", "SUPER_ADMIN")
                        .requestMatchers("/api/vendors/**").hasAnyRole("GARAGE_ADMIN", "SUPER_ADMIN")
                        .requestMatchers("/api/purchase-orders/**").hasAnyRole("GARAGE_ADMIN", "SUPER_ADMIN")
                        .requestMatchers("/api/stock-in/**").hasAnyRole("GARAGE_ADMIN", "SUPER_ADMIN")
                        .requestMatchers("/api/counter-sales/**").hasAnyRole("GARAGE_ADMIN", "SUPER_ADMIN")
