          ...
          <div className="sm:col-span-2 lg:col-span-1">
            <Link href="/" className="inline-flex items-center gap-2 group">
              ...
              <span className="text-xl font-bold tracking-tight text-white">
                Car <span className="text-primary">Affair</span>
              </span>
            </Link>
            ...
            <div className="mt-6 flex items-center gap-3">
              ...
              <a
                href="#"
                aria-label="Facebook"
                className="flex items-center justify-center h-9 w-9 rounded-full bg-gray-800 text-gray-400 transition-all duration-200 hover:bg-primary hover:text-white"
              >
